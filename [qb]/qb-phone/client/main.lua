...
RegisterNUICallback('GetNotes', function(_, cb)
    QBCore.Functions.TriggerCallback('qb-phone:server:GetNotes', function(notes)
        cb(notes)
    end)
end)

RegisterNUICallback('SaveNote', function(data, cb)
    TriggerServerEvent('qb-phone:server:SaveNote', data)
    cb('ok')
end)
...
RegisterNUICallback('DeleteNote', function(data, cb)
    ...
    TriggerServerEvent('qb-phone:server:DeleteNote', data.id)
    cb('ok')
end)
