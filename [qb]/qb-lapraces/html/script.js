    ...
    if (type == "creator") {
        if (data.active) {
            if (!CreatorActive) {
                ...
                $("#editor-keys-tiredistance").html('<span style="color: rgb(0, 201, 0);">+ ] </span> / <span style="color: rgb(255, 43, 43);">- [</span> - Radius ['+data.data.TireDistance+'.0]');
        ...
        if (data.active) {
            if (!RaceActive) {
                ...
                if (data.data.TotalLaps == 0 || data.data.TotalLaps == 1) {
                ...
                if (data.data.BestLap !== 0 || data.data.BestLap !== 1) {
